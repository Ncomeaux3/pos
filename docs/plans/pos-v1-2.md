...
| 3b Apple shell | Floating glass capsule tab bar (Home, Tasks, Finance, Calendar, Browse) that shrinks on scroll down and scrubs between tabs; initials avatar on tab roots opening Settings, Notifications, Agent log, theme and Sign out; utilities out of Browse and the rail footer; system font first | medium | 2 | 3a, #112 | PR open 2026-09-20: capsule, shrink, scrub, avatar menu through a shell context, Browse and rail trimmed, system font first; owner phone check pending | #114 |
