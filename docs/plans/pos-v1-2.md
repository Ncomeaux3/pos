...
| 5a Finance: full pull, pending, categories | 90-day re-pull button, pending marked, transfers out of spending, credits net, new categories, rule offer on manual override | high | 4 | 1b | Built 2026-09-21: `kind` on categories with eleven new ones, budgets are the expense kind only and skip pending, built-in payment and credit rules plus refund matching, Pull 90 days with per-account counts, the rule offer under a filed row | |
