  ...
  return (
    <span className="flex items-center justify-between gap-2.5">
      ...
      <button
        ...
        className="num shrink-0 border border-rule-2 px-[7px] py-[3px] text-[10px] tracking-[0.08em] text-ink-2 transition-colors duration-150 hover:border-ink hover:text-ink rounded-full"
      >
        {shown ? 'HIDE' : 'REVEAL'}
      </button>
      <Copy value={value} />
