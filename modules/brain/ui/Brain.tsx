...
export function Brain({ data }: { data: BrainData }) {
  ...
  return (
    <>
      <header className="-mx-[18px] -mt-[max(18px,calc(var(--inset-t)+8px))] flex min-h-14 flex-wrap items-center justify-between gap-4 border-b border-rule px-[18px] pb-2 pt-[calc(8px+var(--inset-t))] md:-mx-7 md:-mt-7 md:px-7 lg:h-14 lg:flex-nowrap lg:py-0">
        <BackControl />
